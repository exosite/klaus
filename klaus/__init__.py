...
class Klaus(flask.Flask):
    ...
    def setup_routes(self):
        for endpoint, rule in [
            ...
            ('blob',        '/<path:repo>/blob/<rev>/'),
            ('blob',        '/<path:repo>/blob/<rev>/<path:path>'),
            ('blame',       '/<path:repo>/blame/<rev>/'),
            ('blame',       '/<path:repo>/blame/<rev>/<path:path>'),
            ('raw',         '/<path:repo>/raw/<rev>/'),
            ('raw',         '/<path:repo>/raw/<rev>/<path:path>'),
            ('commit',      '/<path:repo>/commit/<rev>/'),
            ('patch',       '/<path:repo>/commit/<rev>.diff'),
            ('patch',       '/<path:repo>/commit/<rev>.patch'),
            ('index',       '/<path:repo>/'),
            ('history',     '/<path:repo>/tree/<rev>/'),
            ('history',     '/<path:repo>/tree/<rev>/<path:path>'),
            ('download',    '/<path:repo>/tarball/<rev>/'),
        ]:
